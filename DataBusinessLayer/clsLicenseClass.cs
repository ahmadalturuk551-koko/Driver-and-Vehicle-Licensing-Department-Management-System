...
namespace DataBusinessLayer
{
    public class clsLicenseClass
    {
        ...
        public static clsLicenseClass Find(int ID)
        {
            ...
            if (clsLicenseClassDataAccess.GetLicenseClassInfoByID(ID, ref ClassName, ref ClassDescription, ref MinimumAllowedAge, ref DefaultValidityLength, ref ClassFees))
