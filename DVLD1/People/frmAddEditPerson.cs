    ...
    public partial class frmAddEditPerson : Form
    {
        ...
        private void _LoadData()
        {
            ...
            else
            {
                ...
                mtbNationalNo.Text = _Person.NationalNo;

                mtbPhone.Text = _Person.Phone;
                mtbSecondName.Text = _Person.SecondName;
                mtbThirdName.Text = _Person.ThirdName;
        ...
        private void _FillPersonInfo()
        {
            ...
            if (mtbThirdName.Text == null || mtbThirdName.Text == "")
                _Person.ThirdName = "";
            else
                _Person.ThirdName = mtbThirdName.Text;
            ...
            _Person.NationalNo = mtbNationalNo.Text;
        ...
        private void _HandleImage()
        {
            ...
            if (pbPersonImage.Image != null && !string.IsNullOrEmpty(openFileDialog1.FileName))
            {
                ...
                string targetDir = @"C:\DVLD-People-Images";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(rtbAddress.Text) || string.IsNullOrEmpty(mtbNationalNo.Text)
               || string.IsNullOrEmpty(mtbName.Text) || string.IsNullOrEmpty(mtbSecondName.Text)
            ...
            else
            {
                ...
                BackPersonID?.Invoke(this, _Person.ID);
            }
        ...
        private void mtbNationalNo_Validating(object sender, CancelEventArgs e)
        {
            if (clsPerson.IsPersonExist(mtbNationalNo.Text))
            {
        ...
        private void mtbNationalNo_MaskInputRejected(object sender, MaskInputRejectedEventArgs e)
        {
